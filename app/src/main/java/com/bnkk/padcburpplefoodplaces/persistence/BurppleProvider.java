...
public class BurppleProvider extends ContentProvider {
    ...
    public static final int GUIDES = 400;
    public static final int SHOP = 500;
    ...
    static {
        ...
        sPromotionWithShop_IJ.setTables(
                BurppleContract.PromotionsEntry.TABLE_NAME + " INNER JOIN " +
                        ...
                        BurppleContract.PromotionsEntry.TABLE_NAME + "." + BurppleContract.PromotionsEntry.COLUMN_PROMOTION_SHOP_ID + " = " +
    ...
    public String getType(@NonNull Uri uri) {
        switch (sUriMatcher.match(uri)) {
            case FEATURED:
                return BurppleContract.FeatruredEntry.DIR_TYPE;
            case PROMOTIONS:
                return BurppleContract.PromotionsEntry.DIR_TYPE;
            case PROMOTION_TERMS:
                return BurppleContract.PromotionTermsEntry.DIR_TYPE;
            case GUIDES:
    ...
    private static UriMatcher buildUriMatcher() {
        ...
        uriMatcher.addURI(BurppleContract.CONTENT_AUTHORITY, BurppleContract.PATH_PROMOTIONS_TERMS, PROMOTION_TERMS);
        uriMatcher.addURI(BurppleContract.CONTENT_AUTHORITY, BurppleContract.PATH_GUIDES, GUIDES);
        uriMatcher.addURI(BurppleContract.CONTENT_AUTHORITY, BurppleContract.PATH_SHOP, SHOP);
    ...
    private String getTableName(Uri uri) {
        switch (sUriMatcher.match(uri)) {
            case FEATURED:
                return BurppleContract.FeatruredEntry.TABLE_NAME;
            case PROMOTIONS:
                return BurppleContract.PromotionsEntry.TABLE_NAME;
            case PROMOTION_TERMS:
                return BurppleContract.PromotionTermsEntry.TABLE_NAME;
            case GUIDES:
    ...
    private Uri getContentUri(Uri uri) {
        switch (sUriMatcher.match(uri)) {
            case FEATURED:
                return BurppleContract.FeatruredEntry.CONTENT_URI;
            case PROMOTIONS:
                return BurppleContract.PromotionsEntry.CONTENT_URI;
            case PROMOTION_TERMS:
                return BurppleContract.PromotionTermsEntry.CONTENT_URI;
            case GUIDES:
